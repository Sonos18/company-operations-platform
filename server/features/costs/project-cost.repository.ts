...
export class ProjectCostRepository implements ProjectCostDataRepository {
  ...
  createDetailDraft(context: ProjectCostRequestContext, projectId: string, input: CreateProjectCostDetailDraftInput, idempotencyKey: string) { return this.detailCommand('c1_create_project_cost_detail_draft', context, { target_input: { projectId, ...input }, target_idempotency_key: idempotencyKey }) }
  ...
  publishDetail(context: ProjectCostRequestContext, id: string, input: { expectedVersion: number }, idempotencyKey: string) { return this.detailCommand('c1_publish_project_cost_detail', context, { target_id: id, target_input: input, target_idempotency_key: idempotencyKey }) }
  createAndPublishDetail(context: ProjectCostRequestContext, projectId: string, input: CreateAndPublishProjectCostDetailInput, idempotencyKey: string) { return this.detailCommand('c1_create_and_publish_project_cost_detail', context, { target_input: { projectId, ...input }, target_idempotency_key: idempotencyKey }) }
