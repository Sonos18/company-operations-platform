...
export class ProjectCostService {
  ...
  async createDetailDraft(context: ProjectCostServiceContext, value: unknown, idempotencyKey: string) { requirePermission(context, 'cost.manage'); return this.repository.createDetailDraft(context, input(createProjectCostDetailDraftInputSchema, value), idempotencyKey) }
  ...
  async publishDetail(context: ProjectCostServiceContext, id: string, value: unknown, idempotencyKey: string) { requirePermission(context, 'cost.publish_import'); return this.repository.publishDetail(context, id, input(publishProjectCostDetailInputSchema, value).expectedVersion, idempotencyKey) }
  async createAndPublishDetail(context: ProjectCostServiceContext, value: unknown, idempotencyKey: string) {
    ...
    return this.repository.createAndPublishDetail(context, input(createAndPublishProjectCostDetailInputSchema, value), idempotencyKey)
  }
