  ...
  <UCard class="journey-stage-card" :class="{ 'is-focused': focused }" data-testid="journey-stage-card" :data-focused="String(focused)">
    <template v-if="focused">
      ...
      <div class="stage-card-copy">
        ...
        <UButton class="stage-open-action" :to="`/projects/${projectId}/stages/${stage.id}`" trailing-icon="i-lucide-arrow-right">
...
.journey-stage-card.is-focused :deep([data-slot='body']) { display: grid; grid-template-rows: minmax(180px, 1fr) auto; }
