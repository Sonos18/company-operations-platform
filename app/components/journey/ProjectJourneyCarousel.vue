...
.journey-carousel__track { display: grid; grid-template-columns: 18% 3% 58% 3% 18%; align-items: center; height: calc(100% - 88px - 86px - 220px); overflow: hidden; background: #e9ebe5; }
