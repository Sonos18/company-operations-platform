...
export const costEvidenceKindSchema = z.enum(['contract', 'acceptance_record', 'invoice', 'accounting_support', 'payment_proof', 'source_workbook', 'other'])
...
export const costEvidenceUploadIntentSchema = costEvidenceIntentAckSchema
...
export const costEvidenceDetailLinkInputSchema = z.object({ evidenceFileId: uuid, evidenceKind: costEvidenceKindSchema }).strict()
export const costEvidenceDetailLinkResultSchema = z.object({ linkId: uuid, detailId: uuid, evidenceFileId: uuid, evidenceKind: costEvidenceKindSchema, replayed: z.boolean() }).strict()
...
export type CostEvidenceDetailLinkInput = z.infer<typeof costEvidenceDetailLinkInputSchema>
export type CostEvidenceDetailLinkResult = z.infer<typeof costEvidenceDetailLinkResultSchema>
