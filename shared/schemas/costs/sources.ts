...
export const accountingSourceVersionSchema = z.object({ id: uuid, sourceId: uuid, versionNo: z.number().int().positive(), inputFileIdentity: text, inputFileSha256: z.string().regex(/^[a-f0-9]{64}$/i), originalFilename: text, rawFileReference: z.string().nullable(), status: sourceStatusSchema, sourceVersionLabel: z.string().nullable(), sourcePeriodText: z.string().nullable(), sourceAsOfText: z.string().nullable(), version, createdAt: timestamp, sharedAt: timestamp.nullable() }).strict()
