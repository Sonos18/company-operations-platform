...
begin
  ...
  insert into public.projects(id,tenant_id,company_id,code,name,origin,created_by) values('c1f30000-0000-4000-8000-000000000101',v_tenant,v_company,'C1F3-P','C1F3 project','manual',v_actor),('c1f30000-0000-4000-8000-000000000102',v_tenant,v_other_company,'C1F3X-P','C1F3 foreign project','manual',v_actor);
  ...
  insert into public.business_parties(id,tenant_id,company_id,code,display_name,party_kind,created_by,updated_by) values('c1f30000-0000-4000-8000-000000000601',v_tenant,v_company,'C1F3-SUB','C1F3 subcontractor','organization',v_actor,v_actor);
