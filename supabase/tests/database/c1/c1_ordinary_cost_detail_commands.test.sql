...
set local role authenticated;
select throws_ok($$select public.c1_publish_project_cost_detail('c1d10000-0000-4000-8000-000000000020',(select (result->>'id')::uuid from c1d_sibling),1,'c1d10000-0000-4000-8000-000000000610','c1d10000-0000-4000-8000-000000000718')$$,'P0001','COST_DETAIL_PUBLISH_NOT_READY','publish revalidates a persisted source that became non-shared');
reset role;
alter table public.source_reported_figures disable trigger all;
...
set local role authenticated;
select throws_ok($$select public.c1_publish_project_cost_detail('c1d10000-0000-4000-8000-000000000020',(select (result->>'id')::uuid from c1d_sibling),1,'c1d10000-0000-4000-8000-000000000611','c1d10000-0000-4000-8000-000000000719')$$,'P0001','COST_DETAIL_PUBLISH_NOT_READY','publish revalidates an open blocking review issue on a persisted source');
reset role;
