...
begin
  ...
  foreach v_function_id in array array['private.c1_can_read_import_draft(uuid,uuid)'::regprocedure, 'private.c1_jsonb_canonical_text(jsonb)'::regprocedure, 'private.c1_assert_controlled_import_mapping(uuid,uuid,jsonb)'::regprocedure, 'private.c1_persist_controlled_import(uuid,jsonb,text,uuid)'::regprocedure, 'private.c1_get_controlled_import_result(uuid,uuid)'::regprocedure] loop
