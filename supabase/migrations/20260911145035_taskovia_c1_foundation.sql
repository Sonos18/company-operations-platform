...
revoke all on function public.c1_create_project(uuid,jsonb,uuid), public.c1_create_business_party(uuid,jsonb,uuid), public.c1_create_engagement(uuid,uuid,jsonb,uuid), public.c1_create_engagement_component(uuid,uuid,jsonb,uuid), public.c1_update_project(uuid,uuid,jsonb,uuid), public.c1_update_business_party(uuid,uuid,jsonb,uuid), public.c1_update_engagement(uuid,uuid,jsonb,uuid), public.c1_update_engagement_component(uuid,uuid,jsonb,uuid) from public, anon, authenticated;
...
revoke all on function private.c1_master_context(uuid,text), private.c1_create_project(uuid,jsonb,uuid), private.c1_create_party(uuid,jsonb,uuid), private.c1_create_engagement(uuid,uuid,jsonb,uuid), private.c1_create_component(uuid,uuid,jsonb,uuid), private.c1_update_project(uuid,uuid,jsonb,uuid), private.c1_update_party(uuid,uuid,jsonb,uuid), private.c1_update_engagement(uuid,uuid,jsonb,uuid), private.c1_update_component(uuid,uuid,jsonb,uuid) from public, anon, authenticated;
