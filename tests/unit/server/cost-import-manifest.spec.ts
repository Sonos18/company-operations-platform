...
const base = { schemaVersion: '1.2', workbookFamily: 'synthetic-ledger-v1', adapter: { id: 'synthetic-ledger', version: '1.0.0' }, targetCompanyId: company, inputs: [{ fileIdentity: 'source', sha256: 'a'.repeat(64), originalFilename: 'source.xlsx' }], sources: [{ id: 'source-1', code: 'S1', title: 'Synthetic', sourceSystem: 'synthetic' }], sourceVersions: [{ id: 'source-1-v1', sourceId: 'source-1', inputFileIdentity: 'source', inputFileSha256: 'a'.repeat(64), originalFilename: 'source.xlsx', rawFileReference: null, sourceVersionLabel: null, sourcePeriodText: null, sourceAsOfText: null }], sections: [{ id: 's1', sourceVersionId: 'source-1-v1', inputSha256: 'a'.repeat(64), locator: { kind: 'cell_range', sheetName: ' 日本 ', range: 'B1:A2' }, mapping: { state: 'pending' }, observedLabels: ['x'], rawValues: ['0'], unresolvedIssues: [] }], figures: [], reviewIssues: [], duplicateCandidates: [], expected: { sources: 1, versions: 1, sections: 1, figures: 0, reviewIssues: 0 } }
